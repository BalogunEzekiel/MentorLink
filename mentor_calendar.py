...
def show_calendar():
    ...
    with tabs[0]:
        ...
        df = pd.DataFrame([{
            ...
            "Rating": s.get("rating") or "Pending"
        } for s in sessions])
        ...
        # Allow clicking from a dropdown to view details (Plotly doesn't support real click in Streamlit)
